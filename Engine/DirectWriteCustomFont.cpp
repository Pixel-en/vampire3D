...
//
//// 初期化処理
//HRESULT DirectWriteCustomFont::Init(IDXGISwapChain* swapChain,HWND hwnd)
//{
//	HRESULT result = S_OK;
//
//	// Direct2Dファクトリ情報の初期化
...
//// options：テキストの整形
////====================================
//HRESULT DirectWriteCustomFont::DrawString(std::string str, XMFLOAT2 pos, D2D1_DRAW_TEXT_OPTIONS options, bool shadow)
//{
//	HRESULT result = S_OK;
//
//	// 文字列の変換
...
//}
//
//HRESULT DirectWriteCustomFont::AddPath(std::string filename)
//{
//	FontList::FontPath.push_back(StringToWString(filename));
//	return FontLoader();
//
//}
